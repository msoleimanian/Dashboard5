...
def SimulationConstructor():
    ...
    def generate_logical_random_data(num_subplots, generation, pot_number):
        ...
        filename = f'Generation{generation}_Pot{pot_number}_Simulation.csv'
    ...
    if optionpot == 1:
        # Replace 'Dataset/Pock choy /Generation3_pot1.csv' with the actual path to your CSV file
        file_path = 'Generation3_Pot1_Simulation.csv'

    if optionpot == 2:
        file_path = 'Generation3_Pot2_Simulation.csv'
    # Read the CSV file into a pandas DataFrame
    df = pd.read_csv(file_path)
    ...
    with col1:
        ...
        df = pd.read_csv('Generation3_Pot1_Simulation.csv')
        # Create button grid
