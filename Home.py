...
def homepageconstructor():
    ...
    html_content = f"""
                                        <div style="border: 2px solid #333333; padding:10px; border-radius:5px;">
                                                            ...
                                                            <p>Unearth the insights hidden within your past data and discover the optimal conditions for plant growth and overall farm performance. This menu allows you to delve into the rich history of your agricultural endeavors, comparing different plantings and generations to identify patterns and trends.
...
Navigate through the various generations of your crops. Examine the conditions, challenges, and successes of each generation. This feature empowers you to learn from the past and make data-driven decisions to optimize future generations.
    ...
    html_content = f"""
                                            <div style="border: 2px solid #333333; padding:10px; border-radius:5px;">
                                                                ...
                                                                <p>Experience the cutting-edge technology of Digital Twin, where the virtual meets the real-time. Our system provides immersive 3D models of your greenhouse, offering a detailed and interactive view of each plant's current status.
